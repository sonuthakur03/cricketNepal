// src/pages/ForgotPasswordPage.jsx — Premium dark redesign

import { useState } from 'react'
import { Link } from 'react-router-dom'
import { motion } from 'framer-motion'
import { HiOutlineMail, HiOutlineCheckCircle, HiArrowLeft } from 'react-icons/hi'
    ...
    >
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm" style={{ color: 'var(--text-muted)' }}>We'll send a link to your registered email</p>
        </div>
          ...
          {sent ? (
            <div className="text-center space-y-4 py-4">
              ...
              <p className="text-sm" style={{ color: 'var(--text-muted)' }}>
                We sent a 15-minute reset link to{' '}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  <HiOutlineMail className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4" style={{ color: 'var(--text-muted)' }} />
              ...
              <div className="text-center">
                <Link to="/login" className="inline-flex items-center gap-1.5 text-sm transition-colors" style={{ color: 'var(--gold-400)', fontFamily: 'var(--font-display)' }}>

...
function AuthLayout({ title, subtitle, children }) {
  return (
    <div
      className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-slate-50 to-amber-50/20 dark:from-dark-950 dark:to-dark-900 px-4 py-12"
    ...
    >
      ...
      >
        ...
        <div className="card p-7 shadow-xl">{children}</div>
      </motion.div>
    </div>
  );
}
...
export function LoginPage() {
  ...
  return (
    <AuthLayout
      title="Welcome Back"
      subtitle="Log in to your Pitch Nepal account"
    >
...
export function RegisterPage() {
  ...
  return (
    <AuthLayout
      ...
      subtitle="Join Nepal's premier cricket store"
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
